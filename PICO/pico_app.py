...
class PicoGuildSim:
    ...
    def _draw_footer(self):
        ...
        self.d.fill_rect(0, 150, 128, 10, COL_SHADE_1)
    ...
    def _draw_bar_row(self, y, active):
        fill = COL_SHADE_2 if active else COL_SHADE_1
    ...
    def render_missions(self):
        ...
        if missions and self.cursor < len(missions):
            ...
            self.d.fill_rect(92, 106, 34, 38, COL_SHADE_2)
            ...
            self.d.fill_rect(2, 142, 124, 8, COL_SHADE_2)
    ...
    def render_seeds(self):
        ...
        self.d.fill_rect(2, 140, 124, 10, COL_SHADE_2)

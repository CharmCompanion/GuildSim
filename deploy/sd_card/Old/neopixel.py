...
except ImportError:  # Allows desktop linting; target runtime is MicroPython.
    Pin = object
...
from encoder_menuBAK import stop, make_task,menu_data
import encoder_menuBAK

if TYPE_CHECKING:
    # Symbols provided implicitly by rp2.asm_pio DSL in MicroPython.
    def wrap_target(): ...
    def label(_name): ...
    def out(_dst, _bits): ...
    def jmp(_cond, _target=None): ...
    def not_x(): ...
    def nop(): ...
    def wrap(): ...
    x = None
